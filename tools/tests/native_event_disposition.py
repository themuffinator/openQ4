...
def main():
    ...
    try:
        ...
        planned_mutations = {
            ...
            'plan-skip-admission-order': ('ticket.emission - 1 != NextEmission(admissionCursor[pass], emission.pass)', '(void(pass),false)'),
            ...
            'plan-skip-child-parent': ('!inFlight || plannedInFlight != emission.trigger', 'false'),
