        ...
        try:
            ...
            for name,source in cases:
                ...
                if source is not None:
                    ...
                    for relative in ['src/framework/EventLoop.h', 'src/sys/EventRetirement.h', 'src/framework/NativeInputRoute.h', 'src/framework/NativeInputRoute.cpp', 'src/framework/NativeInputDispatch.h', 'src/ui/retained/TextInputBroker.h', 'src/ui/retained/TextInput.h', 'src/ui/retained/NativeTextDocument.h']:
                ...
                result=run([compiler,"-std=c++20","-O2","-Wall","-Wextra","-Werror",*includes,"-I",str(scratch),"-I",str(ROOT),
                            str(ROOT/SOURCES[3]),str(ROOT/"src/sys/EventQueueContinuity.cpp"),str(ROOT/"src/sys/EventDisposition.cpp"),str(ROOT/"src/framework/NativeInputRoute.cpp"),str(ROOT/"src/framework/NativeInputDispatchDisabled.cpp"),"-o",str(executable)])
