...
- `r_shadowMapReport` and `gfxInfo` report the modern shadow plan: mapped, stencil-fallback, and skipped lights; projected/point/CSM counts; caster/receiver totals; budgeted shadow size, pixels, and update cadence; and unsupported-resource fallback reasons.
